    ...
    <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginTop: 4 }}>
            {EMOJIS.map(e => (
              <button key={e} type="button" onClick={() => set('emoji', e)} style={{
                width: 44, height: 44, borderRadius: 6, border: `2px solid ${form.emoji === e ? '#c8a84b' : 'rgba(255,255,255,0.1)'}`,
      ...
      <div style={{ display: 'flex', gap: 12, paddingTop: '1rem', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
        ...
        <button type="button" onClick={() => router.push('/admin/products')} style={{
          background: 'transparent', color: 'rgba(240,245,236,0.5)', border: '1px solid rgba(255,255,255,0.1)',
          borderRadius: 6, padding: '0.75rem 1.5rem', fontWeight: 600, fontSize: '0.88rem',
